...
The sixth SEOkomm with a day full of topics about search engine optimisation in a nice atmosphere allured over 800 people to Salzburg.
...
So told speaker [Karl Kratz] that after a chat about steaks during a car driving Google now later suggested steak houses.
Scary, isn't it?
...
Another excellent [talk about PageSpeed](http://bit.ly/1lLLKKz) was held by [Bastian Grimm](http://www.peakace.de).
...
Or you could use the Page Visibility API, which helps to load resources conditionally based on their visibility.
...
Unfortunately WebP is not supported by all browsers yet, but why not serving it to those who can use it already. One could replace PNGs and JPGs per rewrite via .htaccess or use the HTML5-tag &lt;picture&gt; with &lt;img&gt; as fallback.
...
The talk of [Karl Kratz](http://www.google.de) was very thought-provoking.
...
All in all it was a good, well organised conference.
